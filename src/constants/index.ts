...
export const SUPPORTED_DEXAPPBUILDER_CHAIN_IDS = [
  ...
  CHAIN_IDS.Blast,
  CHAIN_IDS.Sepolia,
  CHAIN_IDS.BNB_Smart_Chain_Testnet,
];
...
export const DEFAULT_DEXAPPBUILDER_NETWORKS = CHAINS.filter((ch) =>
  SUPPORTED_DEXAPPBUILDER_CHAIN_IDS.includes(ch.chainId)
);
